...
<html>
  ...
  <body>
    ...
    <?php 
      ...
      echo "<p>The levenshtein() function has determined that &quotl; $LevenshteinWord1 &quotl; and &quotl; $LevenshteinWord2 &quotl; are the most similar names.</p>\n";
      echo "<p>The similar_text() function has determined that &quotl; $SimilarTextWord1 &quotl; and &quotl; $SimilarTextWord2 &quotl; are the most similar names.</p>\n";
    ?>
