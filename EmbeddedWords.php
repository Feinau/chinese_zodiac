...
<html>
  ...
  <body>
    ...
    <?php 
      $Phrase = array("Your Chinese zodiac sign tells a lot about your personality", "Embed PHP scripts within an XHTML document.");
      $SignNames = array(
            "Rat",
            "Ox",
            "Tiger",
      ...
      echo "</p>\n";
      echo "<p>The following words can not be made from the letters in the phrase &quot;$Phrase&qout;:";
